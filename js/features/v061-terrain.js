...
function _addRockVarietyV061() {
  ...
  // 既存岩スポットの近傍 + 新規クラスタ位置
  var spots = [
    [-115, -55], [-105, -115], [115, 55], [75, -175], [-55, 185],
    [125, 125], [-235, 45], [45, 235], [235, -45], [-45, -235],
    [145, -45], [-145, -15], [25, 125], [-75, 75], [95, -85],
    [185, 45], [-185, -85], [-115, 195], [245, 105], [105, -225],
    [-310, 160], [310, -110], [160, 310], [-160, -310], [290, 190],
    // 新規クラスター (空白地帯の補強)
    [-60, -50], [80, 30], [-90, 200], [200, -200], [-200, 200],
    [0, -150], [150, 0], [-150, 80], [50, -200], [-50, 250]
  ];
