...
document.getElementById('howto-text').innerHTML = isMobile
  ...
  : 'A〜Eの拠点を占領してチケットで勝利せよ!(制限時間15分)<br>WASD:移動 / マウス:視点 / 左クリック:射撃 / 右クリック:エイム<br>Shift:ダッシュ / Space:ジャンプ / R:リロード / E:乗り物<br>G:グレネード / M:全体マップ / Tab:スコアボード / 1〜4:武器切替<br>⚙ボタンで描画品質・感度の設定';
